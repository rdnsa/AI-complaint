...
const ID = {
  ...
  'viewer.open': 'Ketuk untuk memperbesar',
  'viewer.close': 'Tutup',
  'viewer.zoom_in': 'Perbesar',
  'viewer.zoom_out': 'Perkecil',
  'viewer.hint': 'Cubit, gulir, atau ketuk dua kali untuk zoom · seret untuk menggeser',
  'photo.report': 'Foto dari pelapor',
  ...
  'login.title': 'Masuk',
  'login.description':
    'Untuk supervisor, atau mahasiswa yang ingin ikut papan peringkat. Petugas kebersihan tidak perlu masuk.',
  ...
  'tab.accounts': 'Petugas & Supervisor',
  ...
  'account.title': 'Kelola petugas dan supervisor',
  'account.add_staff': 'Tambah petugas',
  'account.add_supervisor': 'Tambah akun supervisor',
  ...
  'account.role_supervisor': 'Supervisor',
  ...
  'dashboard.title': 'Dashboard Supervisor',
  ...
  'role.supervisor': 'Saya supervisor',
  ...
  'staff.list_empty': 'Belum ada nama petugas. Minta supervisor menambahkannya.',
...
const EN: Record<Key, string> = {
  ...
  'viewer.open': 'Tap to enlarge',
  'viewer.close': 'Close',
  'viewer.zoom_in': 'Zoom in',
  'viewer.zoom_out': 'Zoom out',
  'viewer.hint': 'Pinch, scroll or double-tap to zoom · drag to move around',
  'photo.report': 'Photo from the reporter',
