...
const ID = {
  ...
  'nav.petugas': 'Masuk sebagai SPV',
  'nav.ke_dashboard_spv': 'Buka dashboard SPV',
  'nav.beranda': 'Kembali ke beranda',
  'nav.kembali': 'Kembali',
  'nav.semua_laporan': 'Lihat semua laporan yang masuk',
  'bahasa.label': 'Bahasa',
  'tema.ke_gelap': 'Ganti ke mode gelap',
  'tema.ke_terang': 'Ganti ke mode terang',
  'sandi.lihat': 'Tampilkan password',
  'sandi.sembunyikan': 'Sembunyikan password',
  ...
  'status.berhasil_isi': 'Petugas kebersihan akan melihatnya dan menanganinya. Terima kasih sudah melaporkan.',
  ...
  'tab.pengguna': 'Petugas & SPV',
  'tab.tanya': '🤖 Chatbot AI',
  'tanya.judul': 'Chatbot AI — tanya data laporan',
  'tanya.label_ai': 'Jawaban Chatbot AI',
  'tanya.keterangan':
  ...
  'tanya.placeholder': 'Tanya Chatbot AI, contoh: gedung mana yang paling sering mampet bulan ini?',
  'tanya.kirim': 'Tanya',
  'tanya.berpikir': 'AI sedang mengambil data…',
  'tanya.contoh1': 'Gedung mana yang paling banyak laporan 30 hari terakhir?',
  'tanya.contoh2': 'Berapa rata-rata waktu penyelesaian laporan prioritas tinggi?',
  'tanya.contoh3': 'Jam berapa laporan paling sering masuk?',
  'tanya.contoh4': 'Petugas siapa yang paling banyak menyelesaikan laporan minggu ini?',
  'tanya.contoh4_umum': 'Berapa laporan yang sudah selesai ditangani minggu ini?',
  'tanya.sisa': 'Sisa {n} pertanyaan hari ini',
  'tanya.galat': 'Gagal mendapatkan jawaban',
  'tanya.kosongkan': 'Mulai percakapan baru',
  'aksi.tanya': 'Tanya data',
  'akun.judul': 'Kelola petugas dan SPV',
  'akun.tambah': 'Tambah petugas',
  'akun.tambah_spv': 'Tambah akun SPV',
  'akun.petugas_tanpa_login': 'Petugas cukup nama saja. Nama ini muncul di pilihan "Siapa kamu?" pada halaman petugas.',
  ...
  'dash.hapus': 'Hapus',
  'dash.bukti_wajib': 'Foto toilet yang sudah bersih. AI memeriksa foto sebelum laporan bisa ditandai selesai.',
  'dash.mengunggah': 'Mengunggah…',
  'dash.memeriksa': 'AI memeriksa foto…',
  'dash.bukti': 'Bukti penyelesaian',
  'dash.bukti_terverifikasi': 'Diverifikasi AI: bersih',
  'dash.bukti_ditolak': 'Foto ditolak',
  'dash.bukti_ditolak_kotor': 'Toilet pada foto masih terlihat kotor. Bersihkan lagi, lalu foto ulang.',
  'dash.bukti_ditolak_bukan_toilet':
    'Foto tidak menunjukkan toilet. Ambil foto kondisi toilet yang sudah dibersihkan.',
  'dash.verifikasi_gagal': 'Pemeriksaan foto gagal. Coba lagi sebentar.',
  'dash.alasan_ai': 'Penilaian AI',
  'tab.laporan': 'Laporan',
  'tab.grafik': 'Grafik',
  ...
  'aksi.masuk': 'SPV masuk',
  'aksi.ringkasan': 'Ringkasan harian',
  'aksi.bukti_ditolak': 'Bukti ditolak',
  'aksi.verifikasi_gagal': 'Verifikasi gagal',
  'aksi.kerja': 'Laporan pekerjaan',
  'dash.hapus_konfirmasi': 'Hapus laporan ini secara permanen? Tindakan ini tidak bisa dibatalkan.',

  'tab.pekerjaan': 'Pekerjaan',
  'kerja.judul': 'Laporan pekerjaan',
  'kerja.pilih_jenis': 'Toilet mana yang sudah dibersihkan?',
  'kerja.sebagai': 'Dicatat atas nama {nama}',
  'kerja.label_teks': 'Apa yang sudah dikerjakan?',
  'kerja.placeholder': 'Contoh: lantai dipel, kloset disikat, sabun dan tisu diisi ulang.',
  'kerja.contoh1': 'Menyapu dan mengepel lantai, membuang sampah.',
  'kerja.contoh2': 'Menyikat kloset dan wastafel sampai bersih.',
  'kerja.contoh3': 'Mengisi ulang sabun dan tisu.',
  'kerja.foto': 'Foto hasil pekerjaan (wajib)',
  'kerja.foto_alasan':
    'Foto toilet yang sudah bersih, langsung dari kamera. AI memeriksa foto sebelum laporan disimpan.',
  'kerja.kirim': 'Kirim laporan pekerjaan',
  'kerja.galat_pendek': 'Tulis sedikit lebih jelas apa yang dikerjakan.',
  'kerja.galat_kirim': 'Gagal mengirim laporan pekerjaan',
  'kerja.terkirim': 'Laporan pekerjaan tersimpan',
  'kerja.lapor_lagi': 'Laporkan toilet lain di lantai ini',
  'kerja.keterangan':
    'Catatan toilet yang sudah dibersihkan petugas. Setiap foto sudah diperiksa AI dan dinilai bersih.',
  'kerja.semua_petugas': 'Semua petugas',
  'kerja.kosong': 'Belum ada laporan pekerjaan.',

  'peran.label': 'Kamu siapa?',
  'peran.mahasiswa': 'Saya mahasiswa',
  'peran.mahasiswa_isi': 'Laporkan toilet yang kotor atau rusak.',
  'peran.petugas': 'Saya petugas',
  'peran.petugas_isi': 'Selesaikan laporan dan catat toilet yang sudah dibersihkan.',

  'petugas.judul': 'Halaman Petugas',
  'petugas.keterangan': 'Tanpa login. Cukup pilih namamu.',
  'petugas.siapa': 'Siapa kamu?',
  'petugas.pilih_nama': '— Pilih namamu —',
  'petugas.daftar_kosong': 'Belum ada nama petugas. Minta SPV menambahkannya.',
  'petugas.tab_laporan': 'Laporan mahasiswa',
  'petugas.tab_kerja': 'Sudah saya bersihkan',
  'petugas.tidak_ada_laporan': 'Tidak ada laporan mahasiswa di lantai ini. 👍',
  'petugas.laporan_selesai': 'Laporan selesai. Terima kasih!',
  'petugas.selesaikan': 'Sudah beres — foto buktinya',
  'petugas.kerjakan': 'Saya kerjakan sekarang',
  'petugas.petunjuk_qr':
    'Paling mudah: scan QR di pintu toilet, lalu tekan "Saya petugas". HP ini akan mengingat namamu.',
  'petugas.menunggu': 'Laporan yang menunggu',
  'petugas.semua_beres': 'Semua laporan sudah selesai. 👍',
  'petugas.buka': 'Buka',

  'kamera.judul': 'Kamera',
  'kamera.memulai': 'Menyalakan kamera…',
  'kamera.jepret': 'Ambil foto',
  'kamera.tutup': 'Batal',
  'kamera.coba_lagi': 'Coba lagi',
  'kamera.galat_judul': 'Kamera tidak bisa dibuka',
  'kamera.galat_ditolak':
    'Izin kamera ditolak. Buka pengaturan situs di browser, izinkan kamera, lalu coba lagi.',
  'kamera.galat_tidak_ada': 'Perangkat ini tidak punya kamera yang bisa dipakai.',
  'kamera.galat_tidak_aman': 'Browser ini tidak mengizinkan kamera. Buka situs lewat HTTPS dengan Chrome atau Safari.',
  'kamera.galat_gagal': 'Kamera sedang dipakai aplikasi lain, atau terjadi kesalahan.',
...
const EN: Record<Kunci, string> = {
  ...
  'umum.lantai': 'Floor {n}',
  'nav.petugas': 'Supervisor sign in',
  'nav.ke_dashboard_spv': 'Open the supervisor dashboard',
  'nav.beranda': 'Back to home',
  'nav.kembali': 'Back',
  'nav.semua_laporan': 'See all incoming reports',
  'bahasa.label': 'Language',
  'tema.ke_gelap': 'Switch to dark mode',
  'tema.ke_terang': 'Switch to light mode',
  'sandi.lihat': 'Show password',
  'sandi.sembunyikan': 'Hide password',
  ...
  'status.berhasil_isi': 'The cleaning staff will see it and take care of it. Thanks for reporting.',
  ...
  'tab.pengguna': 'Staff & Supervisors',
  'tab.tanya': '🤖 AI Chatbot',
  'tanya.judul': 'AI Chatbot — ask about the reports',
  'tanya.label_ai': 'AI Chatbot answer',
  'tanya.keterangan':
  ...
  'tanya.placeholder': 'Ask the AI Chatbot, e.g. which building has the most blocked toilets this month?',
  'tanya.kirim': 'Ask',
  'tanya.berpikir': 'AI is fetching data…',
  'tanya.contoh1': 'Which building had the most reports in the last 30 days?',
  'tanya.contoh2': 'What is the average resolution time for high-priority reports?',
  'tanya.contoh3': 'At what hour do reports come in most often?',
  'tanya.contoh4': 'Which staff member resolved the most reports this week?',
  'tanya.contoh4_umum': 'How many reports were resolved this week?',
  'tanya.sisa': '{n} questions left today',
  'tanya.galat': 'Could not get an answer',
  'tanya.kosongkan': 'Start a new conversation',
  'aksi.tanya': 'Data question',
  'akun.judul': 'Manage staff and supervisors',
  'akun.tambah': 'Add staff',
  'akun.tambah_spv': 'Add supervisor account',
  'akun.petugas_tanpa_login': 'Staff need only a name. It appears in the "Who are you?" list on the staff page.',
  'akun.username': 'Username',
  'akun.nama': 'Name',
  ...
  'dash.judul': 'Supervisor Dashboard',
  ...
  'dash.hapus': 'Delete',
  'dash.bukti_wajib': 'Photo of the cleaned toilet. AI checks the photo before the report can be marked done.',
  'dash.mengunggah': 'Uploading…',
  'dash.memeriksa': 'AI is checking the photo…',
  'dash.bukti': 'Proof of completion',
  'dash.bukti_terverifikasi': 'AI-verified: clean',
  'dash.bukti_ditolak': 'Photo rejected',
  'dash.bukti_ditolak_kotor': 'The toilet in the photo still looks dirty. Clean it again, then retake the photo.',
  'dash.bukti_ditolak_bukan_toilet':
    'The photo does not show a toilet. Take a photo of the cleaned toilet.',
  'dash.verifikasi_gagal': 'The photo check failed. Please try again shortly.',
  'dash.alasan_ai': 'AI assessment',
  'tab.laporan': 'Reports',
  'tab.grafik': 'Charts',
  ...
  'aksi.hapus': 'Deletion',
  'aksi.masuk': 'Supervisor sign-in',
  'aksi.ringkasan': 'Daily summary',
  'aksi.bukti_ditolak': 'Proof rejected',
  'aksi.verifikasi_gagal': 'Verification failed',
  'aksi.kerja': 'Work report',
  'dash.hapus_konfirmasi': 'Delete this report permanently? This cannot be undone.',

  'tab.pekerjaan': 'Work log',
  'kerja.judul': 'Work report',
  'kerja.pilih_jenis': 'Which toilet did you clean?',
  'kerja.sebagai': 'Recorded as {nama}',
  'kerja.label_teks': 'What did you do?',
  'kerja.placeholder': 'For example: mopped the floor, scrubbed the toilet, refilled soap and tissue.',
  'kerja.contoh1': 'Swept and mopped the floor, emptied the bins.',
  'kerja.contoh2': 'Scrubbed the toilet and the sink clean.',
  'kerja.contoh3': 'Refilled the soap and tissue.',
  'kerja.foto': 'Photo of the result (required)',
  'kerja.foto_alasan':
    'A photo of the cleaned toilet, straight from the camera. AI checks it before the report is saved.',
  'kerja.kirim': 'Send work report',
  'kerja.galat_pendek': 'Please describe what you did a little more clearly.',
  'kerja.galat_kirim': 'Could not send the work report',
  'kerja.terkirim': 'Work report saved',
  'kerja.lapor_lagi': 'Report another toilet on this floor',
  'kerja.keterangan':
    'Toilets the cleaning staff have cleaned. Every photo has been checked by AI and judged clean.',
  'kerja.semua_petugas': 'All staff',
  'kerja.kosong': 'No work reports yet.',

  'peran.label': 'Who are you?',
  'peran.mahasiswa': "I'm a student",
  'peran.mahasiswa_isi': 'Report a dirty or broken toilet.',
  'peran.petugas': "I'm cleaning staff",
  'peran.petugas_isi': 'Finish reports and record the toilets you cleaned.',

  'petugas.judul': 'Staff Page',
  'petugas.keterangan': 'No sign-in. Just pick your name.',
  'petugas.siapa': 'Who are you?',
  'petugas.pilih_nama': '— Pick your name —',
  'petugas.daftar_kosong': 'No staff names yet. Ask the supervisor to add them.',
  'petugas.tab_laporan': 'Student reports',
  'petugas.tab_kerja': 'I cleaned it',
  'petugas.tidak_ada_laporan': 'No student reports on this floor. 👍',
  'petugas.laporan_selesai': 'Report done. Thank you!',
  'petugas.selesaikan': 'Fixed — take the proof photo',
  'petugas.kerjakan': "I'm on it now",
  'petugas.petunjuk_qr':
    'Easiest: scan the QR on the toilet door, then tap "I\'m cleaning staff". This phone will remember your name.',
  'petugas.menunggu': 'Reports waiting',
  'petugas.semua_beres': 'Every report is done. 👍',
  'petugas.buka': 'Open',

  'kamera.judul': 'Camera',
  'kamera.memulai': 'Starting the camera…',
  'kamera.jepret': 'Take photo',
  'kamera.tutup': 'Cancel',
  'kamera.coba_lagi': 'Try again',
  'kamera.galat_judul': 'Could not open the camera',
  'kamera.galat_ditolak':
    'Camera permission was denied. Allow the camera in your browser site settings, then try again.',
  'kamera.galat_tidak_ada': 'This device has no usable camera.',
  'kamera.galat_tidak_aman': 'This browser does not allow the camera here. Open the site over HTTPS in Chrome or Safari.',
  'kamera.galat_gagal': 'The camera is in use by another app, or something went wrong.',
